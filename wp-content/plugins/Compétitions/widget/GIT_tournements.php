...
// On créater un widget des compétitions 
class GIT_tournements extends WP_Widget
{
    public function __construct()
    {
        // On définit les options du widget
        $widget_ops = [
            "className" => "GB_tournements",
...
<?php
    ...
    public function widget($args, $instance)
    {
        ...
        // Pseudo
        ($instance[''] != 0) ? $pseudo = $instance['pseudo'] : $pseudo = "Johndoe";
        // Email
        ($instance[''] != 0) ? $email = $instance['email'] : $email = "johndoe@gmail.com";
        // Compétition
        ($instance[''] != 0) ? $competition = $instance['competition'] : $competition = "GameOn";
    }
}
